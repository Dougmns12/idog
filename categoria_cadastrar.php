            ...
            <div class="col-xl-9 col-lg-9 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body  p-0 ">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-category-image">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Cadastrar categoria</h1>
                                    </div>
                                    <form action="banco_cadastrar_categoria.php" method="post" class="user">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="nome" aria-describedby="emailHelp" placeholder="Nome do produto">
                                        </div>
